...
int main()
{
    ...
    assert(SubArrayCountForGivenSum::naive_approach(arr,0)
        == SubArrayCountForGivenSum::better_approach(arr,0));
        
    std::vector<int> arr1 { 3, 4, -7, 3, 1, 3, 1, -4, -2, -2 };
    assert(SubArrayCountForGivenSum::naive_approach(arr1,0)
        == SubArrayCountForGivenSum::better_approach(arr1,0));

    std::vector<int> arr2 { 0,0,0};
    assert(SubArrayCountForGivenSum::naive_approach(arr2,0)
        == SubArrayCountForGivenSum::better_approach(arr2,0));
