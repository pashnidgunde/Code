...
int main() {
  ...
  pn::utils::print<std::vector<int>::iterator>(std::begin(vec), std::end(vec));

  rearrange_efficient(std::begin(vec2), std::end(vec2));
  pn::utils::print<std::vector<int>::iterator>(std::begin(vec2),
                                               std::end(vec2));
  ...
  pn::utils::print<std::array<int, 10>::iterator>(std::begin(random),
                                                  std::end(random));
